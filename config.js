...
window.FACILITATOR_PASSCODE    = '1977';
window.FACILITATOR_SECURE_MODE = 'true';
...
(function () {
  ...
  var firebaseConfig = {
    apiKey:      'AIzaSyBqRGIdfguQRIOdU9j_MEo7q-nr9J1CS6c',
    authDomain:  'aiterm-webinar.firebaseapp.com',
    databaseURL: 'https://aiterm-webinar-default-rtdb.europe-west1.firebasedatabase.app',
    projectId:   'aiterm-webinar',
  };
